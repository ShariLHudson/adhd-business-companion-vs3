...
**Library number:** [151_SPARK_COMPANION_RUNTIME_ARCHITECTURE.md](./estate/recognition/library/151_SPARK_COMPANION_RUNTIME_ARCHITECTURE.md) (Architecture Library copy — keep in sync)

**Related:**
- [SPARK_CONVERSATION_INTELLIGENCE_ARCHITECTURE.md](./SPARK_CONVERSATION_INTELLIGENCE_ARCHITECTURE.md) — orchestration authority
- [estate/recognition/SHARED_CAPABILITY_LIBRARY_IMPLEMENTATION.md](./estate/recognition/SHARED_CAPABILITY_LIBRARY_IMPLEMENTATION.md) — capabilities 131–140
- [estate/recognition/library/140_CAPABILITY_LIBRARY_BUILD_ORDER.md](./estate/recognition/library/140_CAPABILITY_LIBRARY_BUILD_ORDER.md) — capability build order
- [estate/recognition/library/060_CURSOR_IMPLEMENTATION_ORDER.md](./estate/recognition/library/060_CURSOR_IMPLEMENTATION_ORDER.md) — Cursor recognition build order
- [estate/ESTATE_ROOM_AWARENESS.md](./estate/ESTATE_ROOM_AWARENESS.md) — visual / conversation / requested / previous / workflow
- [estate/recognition/RECOGNITION_LIFECYCLE_IMPLEMENTATION.md](./estate/recognition/RECOGNITION_LIFECYCLE_IMPLEMENTATION.md) — recognition pipeline
