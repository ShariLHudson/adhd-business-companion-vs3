...
```mermaid
flowchart LR
  subgraph chaos [What Shari faces]
    Ideas[Ideas]
    Tools[Tools]
    Data[Data]
    Noise[Noise]
  ...
  subgraph founder [Founder]
    HQ[Executive Headquarters]
  end
  subgraph outcomes [What Shari gets]
    Clarity[Clarity]
    Momentum[Momentum]
    Memory[Memory]
    Control[Control]
...
flowchart TB
  ...
  subgraph coord [Coordination]
    AW[Awareness]
    CM[Calm Intelligence]
    GV[Governor]
  end
  subgraph shari [Shari sees]
    ONE[One recommendation]
  end
  sources --> AW --> CM --> GV --> ONE
```
