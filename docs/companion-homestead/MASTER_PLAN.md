...
- `LOOK_BOOK.md` — per-room environmental art direction
- `COMPANION_JOURNEY_EXPERIENCE_BIBLE.md` — emotional blueprint
- `lib/companionNeedsIntelligence/` — what the guest needs before a room is chosen

**This is not:** UI design · software architecture · a floor plan for developers · a feature map

**This is:** the **master plan for a real Iowa place** — as if an architect, landscape architect, and Imagineer walked the property together before a single room photograph was taken.
...
# Part I — The Property at a Glance

## Setting

**Location:** Rolling Iowa countryside — Henry County sensibility (honest land, big sky, not tourist Iowa). County gravel road along the **north** property line. Corn and soy beyond the fence rows. Oak and black walnut in the home grove. Wind that means something.

**Scale:** Roughly **14 acres** — large enough to breathe, small enough to feel held. Not an estate. A **homestead**.

**Orientation:** The house **faces south** toward the land it loves. The **front porch faces north** to greet arrival from the drive. The **back deck faces west-southwest** for golden hour. This is Midwest practical: work with the sun, not against it.

## Walking In — First Impression

A guest passes through a **white split-rail front gate** (never locked — only latched) and walks a **gravel drive** lined with native grasses and old maples. Kinsey may appear from the porch — white Lhasa Poo, curious, not performing — then return to Shari's feet.

The house reveals itself slowly: white painted wood, **barn-red** door and shutters, metal roof section over the studio wing glinting on sunny afternoons. Wind chimes. A porch swing. Smoke or steam from the kitchen chimney in winter. Beyond the house: garden color, greenhouse glass, barn silhouette, horse in the far pasture. The land opens south — **fields forever**.

The guest thinks: *Someone lives here. Someone prepared for company.*

---

## Site Plan — Mental Map
...
# Part II — The House — Wings & Logic

The house grew over **three decades** — original 1890s farmhouse core, 2000s studio wing, 2010s greenhouse and library addition. It is **L-shaped**, not open-plan. Rooms have doors. Privacy is architectural.
...
# Part III — Every Room on the Property

For each space: **why here · overlook · light · sound · adjacent · emotional transition**
...
| | |
|---|---|
| **Why here** | Iowa arrival is outdoor. The porch is the room between the world and the home — earned by climate and culture. |
...
| | |
|---|---|
| **Why here** | Heart of the core. Every wing returns here. Fireplace belongs on the interior south wall — heat and gathering. |
...
| | |
|---|---|
| **Why here** | East of living — catches **first sun**. Food and day begin together. |
...
| | |
|---|---|
| **Why here** | Southwest bump-out — widest glass, intended for **looking without fixing**. |
...
| | |
|---|---|
| **Why here** | East wing near kitchen — planning follows nourishment. Table large enough for spread-out papers. |
...
| | |
|---|---|
| **Why here** | **Interior room** — no view on purpose. Executive function needs protection from beauty that invites wandering. |
...
| | |
|---|---|
| **Why here** | Northeast corner — **afternoon clarity**, separation from kitchen domestic warmth |
...
| | |
|---|---|
| **Why here** | Southeast addition — **most glass**, golden hour, color survives here |
...
| | |
|---|---|
| **Why here** | Ground floor toward barn — **hands get dirty**, projects leave the house proper |
...
| | |
|---|---|
| **Why here** | Southwest quiet wing — farthest from arrival noise; **reef aquarium** needs stable wall |
...
| | |
|---|---|
| **Why here** | Northwest — cool afternoon shade protects books; **quietest indoor corner** |
...
| | |
|---|---|
| **Why here** | Upstairs loft above workshop — **travel is departure**; slight separation from daily rooms |
...
| | |
|---|---|
| **Why here** | Unfinished loft above studio — **future must have space without pretending it's done** |
...
| | |
|---|---|
| **Why here** | South-west off living/kitchen — **sunset room**. Day releases here. |
...
| | |
|---|---|
| **Why here** | South of deck — full sun, visible from kitchen and window seat — **life outside the walls** |
...
| | |
|---|---|
| **Why here** | Connects garden → greenhouse → pond → outlook — **movement for thinking** |
...
| | |
|---|---|
| **Why here** | East of garden — **morning sun through glass**; seedlings start here |
...
| | |
|---|---|
| **Why here** | Northwest of house — **big work leaves the home**; horse connects here |
...
| | |
|---|---|
| **Why here** | Southwest of garden, below deck sightline — **celebration is slightly apart** — fire safe, stars visible |
...
| | |
|---|---|
| **Why here** | East rise at property edge — **highest simple seat**; perspective requires a small climb |
...
# Part IV — Outdoor Environment

## Arrival & edges

- **Front gate** — white split-rail, latch not lock  
- **Gravel drive** — curved once so house reveals slowly  
- **Maple and oak grove** — north and east property edges  
- **Prairie grass buffer** — south and west fence lines — coneflower, bluestem, butterfly weed  

## Gardens & cultivation

| Feature | Location | Purpose |
|---------|----------|---------|
| **Kitchen herb wall** | East kitchen exterior | Living thyme, basil, rosemary — scent at window |
| **Vegetable beds** | South garden | Practical food, not hobby farm scale |
| **Coneflower beds** | Garden center | Iowa native color, goldfinch food |
| **Butterfly garden** | South-east garden | Monarch and swallowtail host plants |
| **Hummingbird garden** | Outside reading nook window + garden feeder | Coral honeysuckle, bee balm |
| **Cut flower strip** | Along deck sightline | Seasonal bouquets inside |
...
- Porch swing (north)  
- Back deck rocking chairs (west-southwest)  
- Fire circle stumps and two Adirondacks  
- Outlook bench (east rise)  
- Garden path midway bench (under oak)  
- Greenhouse potting stool (working seat, not leisure)  

## Horse pasture

- **West** beyond barn — visible from office, barn, outlook  
- Single horse — calm presence, not riding school  
- Fence white with wood posts — same language as front gate  

---

# Part V — The Living Residents

**Not mascots. Residents.** They never perform. They simply live here.
...
- **Belongs:** Porch, living room rug, kitchen tile, garden path (on leash), deck at feet  
- **Rhythm:** Morning patrol of porch; nap in sun patch; meets guests once; returns to Shari  
- **Sounds:** Nails on porch, soft bark at squirrels (disciplined), water bowl clink  

## Horse (barn name optional — one calm bay or chestnut)

- **Belongs:** Pasture, barn approach, visible from office window  
- **Rhythm:** Morning hay, midday shade under oak, evening at fence sometimes when Shari walks path  
- **Sounds:** Nickering, grass tear, hooves soft on dirt  

## Cardinals

- **Belongs:** North feeder near porch, oak canopy, snow days prominent  
- **Rhythm:** Dawn chorus; winter red against white — **brief feeder visit, not constant**  

## Goldfinches

- **Belongs:** Coneflower heads in late summer; feeder near garden  
- **Rhythm:** Flocking season — flash of yellow, then gone  

## Hummingbirds

- **Belongs:** Garden feeder, honeysuckle on herb wall trellis  
- **Rhythm:** Dawn and dusk hover — **irregular**, never looped animation  

## Butterflies

- **Belongs:** Butterfly garden, greenhouse door when open, path edges  
- **Rhythm:** Summer afternoon — one or two, not swarm  

## Dragonflies

- **Belongs:** Pond edge, path in July  
- **Rhythm:** Single crossing — rare gift  

## Fireflies

- **Belongs:** Garden edge, pasture margin, fire circle approach  
- **Rhythm:** **Dusk only**, June and July — pulse, not Christmas lights  

## Rabbits (occasional)

- **Belongs:** Garden edge at dawn — not pest narrative, just life  
- **Rhythm:** One flash, Kinsey notices, life continues  
...
- **Light:** Contributes blue-green living light to nook evening — complements lamp, not competes  

---

# Part VI — Property Rhythm

The homestead is **alive without busy**. One motion at a time. One season honest at a time.

## Seasons

| Season | Property character |
|--------|-------------------|
| **Spring** | Mud on paths, crocus at porch, seedlings in greenhouse, oak buds lime-green, horse coat shedding, first cardinal loud |
| **Summer** | Garden peak, fireflies, hummingbirds, deck until late, pond dragonflies, hay scent from neighbor fields |
| **Autumn** | Coneflower seed heads, goldfinches, earlier lamps, first fire circle nights, leaves on porch, harvest feel without festival cosplay |
| **Winter** | Snow on fields, cardinal at feeder, frost on window seat glass, reef and lamps inward, barn visible through bare trees |

## Times of day

| Time | Property character |
|------|-------------------|
| **Morning** | East light — kitchen, planning, greenhouse; Kinsey on porch; horse at fence sometimes |
| **Afternoon** | Office clarity; garden bees; studio color |
| **Golden hour** | Back deck, creative studio, outlook point — **emotional peak of land** |
| **Evening** | Reading nook aquarium glow; fire circle; crickets; day release |
| **Night** | Focus studio candle; reef glow; stars over pasture; house lamp pools — never all lights on |

## Weather

| Weather | Property character |
|---------|-------------------|
| **Rain** | Window seat sacred; porch irrelevant; path empty; greenhouse soothing; rain on metal roof over studio |
| **Snow** | Quiet land; boot scraper; porch light; cardinal; steam from kitchen |
| **Storms** | Rare thunder — shutter sound, Kinsey inside, guests in living room not punished for staying |
| **Sunny** | Full Iowa — fields shimmer, garden calls, not guilt — invitation |

---

# Part VII — Signature Moments — One Per Room
...
# Part VIII — A Day on the Homestead

**For an ADHD entrepreneur — energy and executive function supported by movement, not scheduling software.**
...
### Mental movement map (not software navigation)

Guests learn paths the way guests learn real homes:

- **Threshold loop:** Porch → Living → Kitchen  
- **Quiet loop:** Living → Reading Nook → Window Seat → Garden Path  
- **Work strip:** Kitchen → Planning → Focus → Office  
- **Make strip:** Studio → Workshop → Barn  
- **Land loop:** Deck → Garden → Path → Greenhouse → Outlook → Deck  
- **Horizon:** Adventure Room → Future Wings (when dreaming, not when drowning)  
...
Close your eyes. Walk from the front gate to the outlook bench at dusk. Hear Kinsey. See the horse. Smell rain on oak. Feel the swing. Watch one hummingbird. Sit by the reef glow after sunset.

If you can walk it — the Master Plan is working.

If it feels like a sitemap — start again.
