...
**Spark Estate Product Constitution series (distinct):** Master product principles for Estate Work/companion platform behavior live in **[113 — Spark Estate Product Constitution](./constitution/113_SPARK_ESTATE_PRODUCT_CONSTITUTION.md)** and expand through **114–117** ([series index](./constitution/README.md)). Binding extension: **[128 — Simplicity & Cognitive Load Constitution](./constitution/128_SPARK_ESTATE_SIMPLICITY_AND_COGNITIVE_LOAD_CONSTITUTION.md)** — every release must reduce cognitive effort and pass simplicity / ADHD experience certification. Bridge specification: **[112 — Universal Work & Relationship Platform](./product-specifications/112_UNIVERSAL_WORK_AND_RELATIONSHIP_PLATFORM_SPECIFICATION.md)**. P0.58 Gate 10 remains binding for ADHD ecosystem screen certification; 113–117 + 128 govern Estate product constitutionality.
