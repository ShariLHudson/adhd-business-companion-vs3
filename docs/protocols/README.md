...
| [Spark Card Visual Design & Daily Generation](SPARK_CARD_VISUAL_DESIGN_REFINEMENT_AND_DAILY_GENERATION_SPECIFICATION.md) | **Implemented** | `sparkCardVisualDesignAndDailyGeneration.ts`, one card per day, personal tones, bottom-right placement |
