/**
 * 126 — Browser checklist for Networking Event Blueprint (jsdom).
...
describe("126 Networking Event browser checklist", () => {
    ...
    act(() => {
      root.render(
        <UniversalBlueprintInterface
          ...
          knownContext={{
            purpose: "Warm founder introductions",
  ...
  it("starts Networking Event Quick Start, preserves Work ID on Guided Build, sponsor context sticks", () => {
    click(
    ...
    click(
      container.querySelector(
        `[data-testid='ubi-blueprint-${NETWORKING_EVENT_BLUEPRINT_ID}']`,
      ),
    );
    expect(
    ...
    expect(state?.blueprintId).toBe(NETWORKING_EVENT_BLUEPRINT_ID);
