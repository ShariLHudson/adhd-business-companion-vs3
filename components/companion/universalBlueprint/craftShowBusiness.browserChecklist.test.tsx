/**
 * 201 — Browser checklist for Craft Show Business Blueprint (jsdom).
...
describe("201 Craft Show Business browser checklist", () => {
    ...
    act(() => {
      root.render(
        <UniversalBlueprintInterface
          ...
          knownContext={{
            purpose: "Grow a ceramic booth business through holiday markets",
            products: "Handmade mugs and planters",
          }}
          onWorkReady={(state) => {
  ...
  it("starts Craft Show Business Quick Start and preserves Work ID on Guided Build", () => {
    click(
    ...
    click(
      container.querySelector(
        `[data-testid='ubi-blueprint-${CRAFT_SHOW_BUSINESS_BLUEPRINT_ID}']`,
      ),
    );
    expect(
      container.querySelector("[data-testid='universal-blueprint-preview']")
        ?.textContent,
    ).toMatch(/Craft Show Business/i);
