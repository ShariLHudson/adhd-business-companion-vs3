...
import { ecosystemSignalStoreConfigured } from "@/lib/ecosystem/serverSignalStore";
...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    ecosystemSignalsStoreConfigured: founderSupabaseConfigured(),
    ecosystemSignalsLive: ecosystemSignalStoreConfigured(),
  });
}
