#!/usr/bin/env node
/**
 * Download East Terrace™ ambience from a Songer share link.
 *
 * Usage:
 *   node scripts/fetch-east-terrace-ambience.mjs
 *   node scripts/fetch-east-terrace-ambience.mjs https://songer.co/song/khxe3s8si94k1pnkgixr5bw6
 */
...
const OUT_FILE = path.join(OUT_DIR, "east-terrace-morning-whisper.mp3");

const DEFAULT_URL =
  "https://songer.co/song/khxe3s8si94k1pnkgixr5bw6";
...
async function findAudioUrl(pageUrl) {
  ...
  throw new Error(
    "Could not find audio URL in Songer page. Save the MP3 as public/audio/peaceful-places/east-terrace-morning-whisper.mp3",
  );
}
