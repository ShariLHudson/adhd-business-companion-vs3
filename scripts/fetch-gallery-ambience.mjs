#!/usr/bin/env node
/**
 * Download The Gallery™ ambience from a Songer share link.
 *
 * Usage:
 *   node scripts/fetch-gallery-ambience.mjs
 *   node scripts/fetch-gallery-ambience.mjs https://songer.co/song/n4mxywv47fi61ovoo8994j55
 */
...
const OUT_DIR = path.join(__dirname, "..", "public", "audio", "gallery");
const OUT_FILE = path.join(OUT_DIR, "hall-of-reflections.mp3");

const DEFAULT_URL =
  "https://songer.co/song/n4mxywv47fi61ovoo8994j55";
...
async function findAudioUrl(pageUrl) {
  ...
  throw new Error(
    "Could not find audio URL in Songer page. Save the MP3 as public/audio/gallery/hall-of-reflections.mp3",
  );
}
