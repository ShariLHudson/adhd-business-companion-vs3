#!/usr/bin/env node
/**
 * Download Music Loft™ ambience from a Songer share link.
 *
 * Usage:
 *   node scripts/fetch-music-loft-ambience.mjs
 *   node scripts/fetch-music-loft-ambience.mjs https://songer.co/song/v4fvb42w8x3ejbkik8ce17nq
 */
...
const OUT_FILE = path.join(OUT_DIR, "music-loft-ambience.mp3");

const DEFAULT_URL =
  "https://songer.co/song/v4fvb42w8x3ejbkik8ce17nq";
...
async function findAudioUrl(pageUrl) {
  ...
  throw new Error(
    "Could not find audio URL in Songer page. Save the MP3 as public/audio/peaceful-places/music-loft-ambience.mp3",
  );
}
