#!/usr/bin/env node
/**
 * Download Evening Hearth™ ambience from a Songer share link.
 *
 * Usage:
 *   node scripts/fetch-evening-hearth-ambience.mjs
 *   node scripts/fetch-evening-hearth-ambience.mjs https://songer.co/song/d68o1fbz1lgaplvwovrmamwa
 */
...
const OUT_FILE = path.join(OUT_DIR, "evening-hearth-ambience.mp3");

const DEFAULT_URL = "https://songer.co/song/d68o1fbz1lgaplvwovrmamwa";
...
async function findAudioUrl(pageUrl) {
  ...
  throw new Error(
    "Could not find audio URL in Songer page. Save the MP3 as public/audio/peaceful-places/evening-hearth-ambience.mp3",
  );
}
