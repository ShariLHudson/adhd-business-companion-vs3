...
const BLUEPRINTS: KnowledgeVaultItem[] = [
  ...
  item({
    id: "kv-v1-transition",
    title: "Founder V1 Implementation Transition",
    categoryId: "blueprints",
    purpose: "Build phase declaration — five priorities, permanent dev and doc rules.",
    lastUpdated: "2026-07-06",
    status: "active",
    documentPath: "docs/founder/FOUNDER_V1_IMPLEMENTATION_TRANSITION.md",
    authorityLevel: "blueprint",
    relatedSystems: ["Founder Studio", "Executive Command Center"],
    googleDrivePath: "Visual Spark Studios / Founder Studio / Blueprints",
    inNotebookLmLibrary: true,
    notes: "Read before every implementation sprint after V1 complete.",
  }),
  item({
    id: "kv-arch-summary",
