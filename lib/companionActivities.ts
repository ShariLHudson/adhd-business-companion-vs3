...
export const COMPANION_ACTIVITIES: CompanionActivity[] = [
  ...
  },
  {
    ...
    categoryId: "calm",
    title: "Stretch Break",
    helpsWith: "Gentle movement to reset your neck, shoulders, and hands in 30–90 seconds.",
    timeLabel: "1–2 min",
    steps: [
      s("Neck roll — slowly circle your chin toward each shoulder. Two easy breaths each way."),
      s("Shoulder roll — lift, roll back and down. Four slow circles."),
      s("Standing stretch — reach up, then fold forward with soft knees. Hang for two breaths."),
      s("Hands & wrists — open your fingers wide, then circle wrists both directions."),
      s("Take one natural breath. Notice what feels looser. Return when ready."),
    ],
  },
  {
    id: "walk-reminder",
    categoryId: "calm",
    title: "Walk Exercise",
    helpsWith: "A short gentle walk to loosen up and clear your head.",
    timeLabel: "2–5 min",
    steps: [
      s("Step away from your screen. No destination needed — just a gentle 2–5 minute walk."),
      s("Notice three things around you — a color, a sound, or something moving."),
      s("Loosen your shoulders on each exhale. Let your pace stay easy."),
      s("Breathe naturally. This is a body reset, not a workout."),
      s("When you're ready, head back. One word for how you feel.", {
        type: "text",
        key: "feel",
        label: "How you feel",
        optional: true,
