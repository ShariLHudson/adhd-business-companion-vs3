...
export const MASTER_FEATURE_REGISTRY: readonly MasterFeatureRecord[] = [
  ...
  row({
    ...
    conversationIntelligenceRequirements:
      "CIE + HCV + TCAI via shared Certified Conversation Pipeline (advisory behavior)",
    cieIntegration: "complete",
    hcvStatus: "complete",
    goldStandardCoverage: "partial",
    uiStatus: "complete",
    backendStatus: "partial",
    routingStatus: "complete",
    authenticatedTesting: "partial",
    productionReadiness: "partial",
    dependencies: ["shared-cie", "hcv"],
    notes:
      "Advisory certifyConversationDelivery wired; answer-first policy; dismiss clears certified state",
  }),
  row({
    id: "board",
  ...
  row({
    ...
    welcomeHomeDestination: "projects",
    estateExperienceId: "momentum",
    estateSpaceId: "goals-projects",
  ...
  row({
    ...
    welcomeHomeDestination: "spark-estate-guide",
    estateExperienceId: "explore",
    estateSpaceId: "homestead",
  ...
  row({
    ...
    welcomeHomeDestination: "wander-the-grounds",
    estateExperienceId: "explore",
    estateSpaceId: "homestead",
