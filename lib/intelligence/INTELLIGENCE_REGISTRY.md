...
| **Executive Command Center™** | `lib/executiveCommandCenter/` | Composes Brief, Missions, Questions, Decisions, Memory, Opportunities, Orchestrator, SPARK, FLAME, FIRE, Concierge, Overnight, Judgment, Discovery, Integration | One executive surface — attention model + headquarters (sample V1); UI: `/companion/founder/executive-command-center` |
