...
export const CHAMBER_MEMBER_ALIASES: Record<ChamberMemberId, readonly string[]> = {
  ...
  "people-culture": [
    ...
    "culture",
    "team culture",
    // HR / hiring domain — People & Culture is the authoritative HR member.
    // Safe: ordinary statements containing these words do not auto-navigate —
    // the CB-022 gate (mayNavigateToChamberMember / isChamberMemberRequest) only
    // navigates on explicit member requests or bare member names.
    "hr",
    "human resources",
    "people operations",
    "workplace culture",
