...
export const TOP_BAR_NEW_CONVERSATION_LABEL = "Start New Conversation";

/** Estate Menu — daily fresh start. */
export const TOP_BAR_NEW_DAY_CONVERSATION_LABEL = "Start New Day Conversation";
...
export const TOP_BAR_NEW_DAYS_CHAT_LABEL = TOP_BAR_NEW_DAY_CONVERSATION_LABEL;
...
export const BEGIN_NEW_DAY_COPY: FreshStartCopy = {
  menuEmoji: "☀️",
  menuLabel: TOP_BAR_NEW_DAY_CONVERSATION_LABEL,
  menuHint:
    "Start a fresh day with the companion — today's plan resets while history and learning stay safe.",
  title: "Start New Day Conversation?",
  intro:
    "A gentle daily reset — your memory, projects, and saved items stay safe. Yesterday's conversation stays accessible.",
  willDo: [
  ...
  confirmLabel: TOP_BAR_NEW_DAY_CONVERSATION_LABEL,
};
...
/** Shown after Start New Conversation — calm opener, not an empty chat. */
export const NEW_CONVERSATION_GREETING =
