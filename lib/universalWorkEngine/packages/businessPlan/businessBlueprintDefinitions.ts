/**
 * Business Plan — domain Blueprint *definitions* only (201–282).
...
import {
  ...
  WELLNESS_PERSONAL_CARE_PET_COLLECTION_DEFINITIONS,
  WELLNESS_PERSONAL_CARE_PET_COLLECTION_ID,
  WELLNESS_PRACTICE_BUSINESS_BLUEPRINT_ID,
} from "./wellnessPersonalCarePetCollectionDefinitions";
import {
  ...
  EDUCATION_COMMUNITY_ORG_COLLECTION_DEFINITIONS,
  EDUCATION_COMMUNITY_ORG_COLLECTION_ID,
...
} from "./educationCommunityOrgCollectionDefinitions";
import {
  ...
  REGULATED_PROFESSIONAL_SERVICES_COLLECTION_DEFINITIONS,
  REGULATED_PROFESSIONAL_SERVICES_COLLECTION_ID,
} from "./regulatedProfessionalServicesCollectionDefinitions";
import {
  ...
  MANUFACTURING_LOGISTICS_AGRICULTURE_COLLECTION_DEFINITIONS,
  MANUFACTURING_LOGISTICS_AGRICULTURE_COLLECTION_ID,
  SMALL_MANUFACTURING_BUSINESS_BLUEPRINT_ID,
  WHOLESALE_DISTRIBUTION_BUSINESS_BLUEPRINT_ID,
} from "./manufacturingLogisticsAgricultureCollectionDefinitions";
import {
  ...
  TECH_MEDIA_CREATIVE_COLLECTION_DEFINITIONS,
  TECH_MEDIA_CREATIVE_COLLECTION_ID,
} from "./techMediaCreativeCollectionDefinitions";
import {
  ...
  SCALE_LOCATION_CHANNEL_COLLECTION_DEFINITIONS,
  SCALE_LOCATION_CHANNEL_COLLECTION_ID,
} from "./scaleLocationChannelCollectionDefinitions";
import {
  ...
  LOCAL_CONSUMER_SERVICE_COLLECTION_DEFINITIONS,
  LOCAL_CONSUMER_SERVICE_COLLECTION_ID,
  PHOTOGRAPHY_VIDEOGRAPHY_BUSINESS_BLUEPRINT_ID,
  WEDDING_CELEBRATION_PROFESSIONAL_BUSINESS_BLUEPRINT_ID,
} from "./localConsumerServiceCollectionDefinitions";
import {
  ...
  FINANCIAL_INVESTMENT_PROPERTY_COLLECTION_DEFINITIONS,
  FINANCIAL_INVESTMENT_PROPERTY_COLLECTION_ID,
...
} from "./financialInvestmentPropertyCollectionDefinitions";
