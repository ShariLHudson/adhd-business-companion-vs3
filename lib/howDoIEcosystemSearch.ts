...
const MAIN_AREA_SECTION: Record<string, AppSection> = {
  ...
  snippets: "snippets",
  "my-work": "my-work",
  "my-work-archive": "my-work",
  "saved-work": "saved-work",
  "created-content": "saved-work",
  "growth-center": "growth-vault",
  "evidence-bank": "evidence-bank",
  "wins-this-week": "wins-this-week",
  growth: "growth-vault",
  "my-highlights": "confidence-vault",
  "confidence-vault": "confidence-vault",
  "my-journey": "my-journey",
  portfolio: "portfolio",
  "growth-reports": "outcome-goals",
  "outcome-goals": "outcome-goals",
  "decision-log": "my-journey",
  "lessons-learned": "my-journey",
  "today-view": "today",
  "learning-resources": "playbook",
  "productivity-help": "plan-my-day",
...
const HIDDEN_ALIASES: Record<string, string[]> = {
  ...
  "outcome-goals": ["outcome goals", "goals", "goal tracking"],
  "decision-log": ["decision log", "decisions"],
  "lessons-learned": ["lessons learned", "lesson"],
  portfolio: ["portfolio", "course", "book", "funnel", "lead magnet", "workshop"],
  "today-view": ["today", "home", "chat home"],
  "chat-companion": ["chat", "conversation", "talk"],
  "evidence-bank": [
    "evidence bank",
    "proof bank",
    "impact",
  ...
  "my-work": ["my work", "continue working", "quick access", "browse my work"],
  "saved-work": ["created content", "saved work", "drafts library"],
  "my-work-archive": ["archive", "archived work", "completed projects"],
};
