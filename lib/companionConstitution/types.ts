...
export const ELEVATE_LIFE_EXPERIENCE_RULE =
  "Every response should leave the user's internal experience a little better than it was before they asked — through understanding, partnership, and practical help, never false positivity." as const;
