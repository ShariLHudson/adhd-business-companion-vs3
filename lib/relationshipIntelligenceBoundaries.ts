...
const SELF_UNDERSTANDING_RE =
  /\b(?:why do i|why am i|why can't i|why can i not|why do i keep|why do i always|why do i never|why do i get stuck|why do i procrastinate|what patterns do you notice|what patterns have you noticed|patterns have you noticed|what do you notice about me|what have you noticed about (?:me|how i)|how have i changed|what has changed about me|how have i grown|why am i stuck|get stuck before i finish|before i finish|how do i tend to|how do i usually|what'?s my pattern|my biggest strength|what am i good at|what i'?m good at|blind spots?|my blind spot|help me understand (?:my|why i|how i)|understand myself|about myself|decision patterns?|how do i (?:tend to )?make decisions|adhd patterns?|my adhd patterns?|behavior change|start but not finish|good starter but poor finisher|poor finisher|keep getting overwhelmed|getting overwhelmed|procrastinate|what makes me|who am i as)\b/i;
