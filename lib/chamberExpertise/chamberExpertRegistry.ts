...
export const CHAMBER_EXPERT_REGISTRY: readonly ChamberExpertRegistryEntryWithCategory[] = [
  {
    ...
    outcomeSignals: ["keep launching things", "grow my business", "grow the business"],
  ...
  },
  {
    ...
    activationSignals: [
      ...
      "ideas never turned into anything",
  ...
  },
  {
    ...
    possibleRelationships: ["PM", "CRE", "PC"],
  ...
  },
  {
    ...
    activationSignals: [
      ...
      "never apply what i learn",
      "keep starting certifications",
      "dropping them halfway",
