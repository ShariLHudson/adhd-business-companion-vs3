...
const AMBIGUITY_GROUPS: readonly AmbiguityGroupDef[] = [
  ...
  },
  {
    ...
    options: [
      {
        destinationId: "back-deck",
        displayName: "Back Deck",
        shortDescription: "evening air and open conversation",
        exclusivePhrases: ["back deck"],
        sortKeywords: ["back", "evening", "outside"],
      },
      {
      ...
      },
      {
        ...
        exclusivePhrases: ["fireside deck"],
        sortKeywords: ["fire", "fireside", "warm"],
      },
    ],
  },
  {
    ...
    intro: "We have a couple of pond spaces. Which one would you like?",
    options: [
      {
        destinationId: "seat-at-pond",
        displayName: "Seat at the Pond",
        shortDescription: "still water and quiet breath",
        sortKeywords: ["seat", "sit", "dock"],
      },
      {
        destinationId: "reflection-pond",
        displayName: "Reflection Pond",
        shortDescription: "stream bench and quiet reflection",
        exclusivePhrases: ["reflection pond"],
        sortKeywords: ["reflection", "stream", "quiet"],
      },
    ],
  },
  {
