...
const EXCLUSIVE_PHRASE_DESTINATIONS: Readonly<Record<string, string>> = {
  ...
  "my personal library": "personal-library",
  "my library": "personal-library",
  "spark collection": "personal-library",
  "my spark collection": "personal-library",
  "saved sparks": "personal-library",
  "my saved sparks": "personal-library",
  "saved items": "personal-library",
  "my saved items": "personal-library",
  "recent saved items": "personal-library",
  "saved card": "personal-library",
  "a saved card": "personal-library",
  "saved note": "personal-library",
  "my saved note": "personal-library",
  "spark card": "personal-library",
  "spark cards": "personal-library",
  "my spark card": "personal-library",
  "my spark cards": "personal-library",
  "spark card collection": "personal-library",
  "spark cards collection": "personal-library",
  "my spark card collection": "personal-library",
  "my spark cards collection": "personal-library",
  "go to spark card": "personal-library",
  "go to spark cards": "personal-library",
  "show me my spark cards": "personal-library",
  "show my spark cards": "personal-library",
  "search my spark cards": "personal-library",
  "search spark cards": "personal-library",
