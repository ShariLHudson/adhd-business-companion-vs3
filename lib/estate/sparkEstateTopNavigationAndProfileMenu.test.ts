...
describe("sparkEstateTopNavigationAndProfileMenu", () => {
  ...
  it("documents Welcome Home categories with Spark Estates last", () => {
    ...
    expect(SPARK_ESTATE_ROOM_MENU_SECTIONS.map((s) => s.label)).toEqual([
      "Today",
      "Build",
      "Guidance",
      "Focus",
    ...
    expect(verification.roomFocusItems).toBe(5);
