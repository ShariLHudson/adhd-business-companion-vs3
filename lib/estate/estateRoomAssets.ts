...
export const ESTATE_ROOM_BG = {
  ...
  chamberOfMomentum: CANONICAL_PLACE_BACKGROUNDS["chamber-of-momentum"],
  creativeStudio: CANONICAL_PLACE_BACKGROUNDS["creative-studio"],
  focusStudio: CANONICAL_PLACE_BACKGROUNDS["focus-studio"],
  cartographersStudio: CANONICAL_PLACE_BACKGROUNDS["cartographers-studio"],
  ...
  swingBeneathTheOak: CANONICAL_PLACE_BACKGROUNDS["the-swing-beneath-the-oak"],
  ...
  personalLibrary: estateBackgroundPath("personal-library-search-recent-background.png"),
...
export const ESTATE_ROOM_BG_BY_ROOM_ID: Readonly<Record<string, string>> = {
  ...
  "butterfly-house": CANONICAL_PLACE_BACKGROUNDS["butterfly-house"],
  ...
  "chamber-of-momentum": ESTATE_ROOM_BG.chamberOfMomentum,
  "creative-studio": ESTATE_ROOM_BG.creativeStudio,
  "focus-studio": ESTATE_ROOM_BG.focusStudio,
  "cartographers-studio": ESTATE_ROOM_BG.cartographersStudio,
  "visual-focus": ESTATE_ROOM_BG.focusStudio,
  ...
  "the-swing-beneath-the-oak": ESTATE_ROOM_BG.swingBeneathTheOak,
